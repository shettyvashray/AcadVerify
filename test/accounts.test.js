...
contract('Accounts', function(accounts) {
  ...
  it('...should register a valid verifier information.', async() => {
    ...
    await accounts.register(account.name, account.email, account.logo, account.description, account.type, account.verificationPrice, account.institute, { from: verifier1 });
  ...
  it('...should not register with invalid email address.', async() => {
    ...
    await expect.throwError(accounts.register(account.name, 'invalid-email', account.logo, account.description, account.type, account.verificationPrice, account.institute, { from: verifier1 }));
  ...
  it('...should register a another valid verifier information.', async() => {
    ...
    await accounts.register(account2.name, account2.email, account2.logo, account2.description, account2.type, account2.verificationPrice, account2.institute, { from: verifier2 });
  ...
  it('...should register a valid requester information.', async() => {
    ...
    await accounts.register(account3.name, account3.email, account3.logo, account3.description, account3.type, account3.verificationPrice, account3.institute, { from: requester });
  ...
  it('...should register another valid requester information.', async() => {
    ...
    await accounts.register(account4.name, account4.email, account4.logo, account4.description, account4.type, account4.verificationPrice, account4.institute, { from: requester2 });
